...
public class TelaDeCadastro extends JFrame {
	 ...
	 */
	//método para limpar/deletar dados. Esse método serve para limpar todos os campos quando algum botão é executado 
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				// Comando para tratar exeções caso o o tela login não consiga chamar a tela cadastro//
				try {
	...
	public TelaDeCadastro() {
		...
		// Botão consultar que chama os dados do banco usando a query SELECT//
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (rs.next()) {
						...
						JOptionPane.showMessageDialog(null,"Usuario " + RA.getText() +" nao existe ou a Senha está incorreta","LOGIN",JOptionPane.ERROR_MESSAGE);
					}
					stmt.close();
					con.close();
		...
		// botão cadastrar que insera dados dentro do banco usando a query de INSERT//
		...
		// Botão que limpa os dados buscados anteriormente para realizar uma nova consulta com o Botão CONSULTA//
