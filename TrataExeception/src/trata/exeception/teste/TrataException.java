...
public class TrataException {
	...
	public static void main(String[] args) {
        ...
        catch(Exception  exc) //CAPTURA DA POSSÍVEL exceção.
        {
           // TRATAMENTO DA exceção
        	JOptionPane.showMessageDialog(null,"A frase inicial está nula, para solucionar tal o problema, foi lhe atribuito um valor default.   " + exc );
             frase = "Frase vazia";
             novaFrase = frase.toUpperCase();
         }
